      ...
      <div class="services">
        <h5>
          <svg
            ...
            fill="none"
            class="injected-svg"
            data-src="/icons/delivery-tracking-01-stroke-rounded.svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            role="img"
            color="#ffffff"
          >
            <path
              d="M12.5 22H10.8889C6.69863 22 4.6035 22 3.30175 20.7447C2 19.4895 2 17.4692 2 13.4286V8H22V10.5"
              stroke="#ffffff"
              stroke-width="1.5"
            ...
            ></path>
            <path
              d="M18 12C15.7909 12 14 13.8089 14 16.0403C14 17.3163 14.5 18.3083 15.5 19.1945C16.2049 19.8191 17.0588 20.8566 17.5714 21.6975C17.8173 22.1008 18.165 22.1008 18.4286 21.6975C18.9672 20.8733 19.7951 19.8191 20.5 19.1945C21.5 18.3083 22 17.3163 22 16.0403C22 13.8089 20.2091 12 18 12Z"
              stroke="#ffffff"
              stroke-width="1.5"
              stroke-linejoin="round"
            ></path>
        ...
        <h5>
          <svg
            ...
            fill="none"
            class="injected-svg"
            data-src="/icons/shopping-cart-01-stroke-rounded.svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            role="img"
            color="#ffffff"
          >
        ...
        <h5>
          <svg
            ...
            fill="none"
            class="injected-svg"
            data-src="/icons/sale-tag-01-stroke-rounded.svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            role="img"
            color="#ffffff"
          >
        ...
        <h5>
          <svg
            ...
            fill="none"
            class="injected-svg"
            data-src="/icons/customer-support-stroke-rounded.svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            role="img"
            color="#ffffff"
          >
        ...
        <h5>
          <svg
            ...
            fill="none"
            class="injected-svg"
            data-src="/icons/safe-delivery-01-stroke-rounded.svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            role="img"
            color="#ffffff"
          >
